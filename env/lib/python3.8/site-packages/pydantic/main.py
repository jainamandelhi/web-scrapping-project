...
if TYPE_CHECKING:
    ...
    Model = TypeVar('Models', bound='BaseModel')
    ...
    class SchemaExtraCallable(typing_extensions.Protocol):
        ...
        @overload  # noqa: F811
        def __call__(self, schema: Dict[str, Any], model_class: Type['Models']) -> None:  # noqa: F811
            pass
...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def __init__(__pydantic_self__, **data: Any) -> None:
        ...
        try:
            ...
            raise TypeError(
                'Models values must be a dict; you may not have returned a dictionary from a root validator'
            ) from e
    ...
    @classmethod
    def parse_obj(cls: Type['Models'], obj: Any) -> 'Models':
    ...
    @classmethod
    def from_orm(cls: Type['Models'], obj: Any) -> 'Models':
    ...
    @classmethod
    def construct(cls: Type['Models'], _fields_set: Optional['SetStr'] = None, **values: Any) -> 'Models':
        """
    ...
    @classmethod
    def validate(cls: Type['Models'], value: Any) -> 'Models':
    ...
    @classmethod
    def _decompose_class(cls: Type['Models'], obj: Any) -> GetterDict:
    ...
    def update_forward_refs(cls, **localns: Any) -> None:
        """
        Try to update ForwardRefs on fields based on this Models, globalns and localns.
        """
...
def create_model(
    ...
    **field_definitions: Any,
    ...
    if __base__ is not None:
        ...
        __base__ = cast(Type['Models'], BaseModel)
